    ...
    <main>
        <div class="bk">
            ...
            <?php echo do_shortcode( '[flexy_breadcrumb]'); ?>
                    ...
                    <div class="portfolio-sec">
                        ...
                        <div class="portfolio-text">
                            ...
                            <div class="link-text">
                                ...
                                <div class="link_flex">
                                    <span>Github：</span>
                                    <a href="https://github.com/hana03/kurisuta-5.30/tree/210711"
                            ...
                            <div class="site-img-pc">
                                <div class="site-img-container">
                                    <div class="site-img-content">
                                        <img class="site-img-pc" src="<?php echo get_template_directory_uri(); ?>/imge/kurisuta-img-pc.png"
                            ...
                            <div class="site-img-sp">
                                <div class="site-img-container">
                                    <div class="site-img-content">
                                        <img class="site-img-sp" src="<?php echo get_template_directory_uri(); ?>/imge/kurisuta-img-sp.png"
                                            style="max-height: 700px;" alt="サンプル模写画像">
                                        <i class="fas fa-times-circle"></i>
                                    </div>
                                </div>
                ...
                <ul class="page-link">
                    <li class="junp"><a href="<?php echo get_permalink(11); ?>"><i class="fas fa-angle-double-left junp"></i>pre</a>
                    </li>
